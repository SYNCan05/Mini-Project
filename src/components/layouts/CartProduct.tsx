...
export default function CartProduct({children, classname="w-[400px] max-md:w-[350px] max-sm:text-xs table-auto border-collapse border shadow-md rounded-lg"}: Props) {
    return (
